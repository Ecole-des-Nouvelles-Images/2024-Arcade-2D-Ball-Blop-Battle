...
namespace _Branches.Hugo.OldScripts.Ball
{
    public class OldBallHandler : MonoBehaviour
    {
        ...
        private void OnCollisionEnter2D(Collision2D other)
        {
            if (other.gameObject.CompareTag("PlayerOneGround"))
            {
                ...
                _oldMatchManager.DisplayScoreChange(false, false);
                ResetVFXSpecialSpike();
                Instantiate(_celebrationPointObject, new Vector3(8, 2, 0), Quaternion.identity);
                if (OldPlayerController.ScrollBackgroundObjects.Count > 0)
                {
                    foreach (GameObject scroll in OldPlayerController.ScrollBackgroundObjects)
                    {
                        Destroy(scroll);
                    }
                }
                ...
                {
                    _lastPlayerGameObject.GetComponent<OldPlayerController>().ResetStatesAfterSpecialSpike();
                ...
                {
                    _currentPlayerGameObject.GetComponent<OldPlayerController>().ResetStatesAfterSpecialSpike();
            ...
            if (other.gameObject.CompareTag("PlayerTwoGround"))
            {
                ...
                _oldMatchManager.DisplayScoreChange(true, false);
                ResetVFXSpecialSpike();
                Instantiate(_celebrationPointObject, new Vector3(-8, 2, 0), Quaternion.identity);
                if (OldPlayerController.ScrollBackgroundObjects.Count > 0)
                {
            ...
            if (other.gameObject.CompareTag("Player"))
            {
                ...
                {
                    _oldMatchManager.IsTimerRunning = true;
                ...
                else if (_currentPlayerGameObject != other.gameObject)
                {
                    ...
                    _lastPlayerGameObject.GetComponent<OldPlayerNumberTouchBallHandler>().NumberTouchBall = 0;
                    
                    // Disable Green Spacial Spike
                    _currentPlayerGameObject.GetComponent<OldPlayerController>().CountShootSpecialSpike = 0;
                }

                if (_lastPlayerGameObject)
                {
                    _lastPlayerGameObject.GetComponent<OldPlayerController>().CountShootSpecialSpike = 0;
                ...
                if (_currentPlayerGameObject.GetComponent<OldPlayerController>()._blop.PlayerName == "Bleu")
                {
                ...
                if (_currentPlayerGameObject.GetComponent<OldPlayerController>()._blop.PlayerName == "Vert")
                {
                ...
                if (_currentPlayerGameObject.GetComponent<OldPlayerController>()._blop.PlayerName == "Jaune")
                {
                ...
                if (_currentPlayerGameObject.GetComponent<OldPlayerController>()._blop.PlayerName == "Rouge")
                {
        ...
        private void OnDestroy()
        {
            if (!OldMatchManager.IsSetOver)
            {
                _oldMatchManager.InvokeMethodTimer("Commitment");
            ...
            if (_currentPlayerGameObject)
            {
                _currentPlayerGameObject.GetComponent<OldPlayerNumberTouchBallHandler>().NumberTouchBall = 0;
                _currentPlayerGameObject.GetComponent<OldPlayerController>().CountShootSpecialSpike = 0;
